var button_connect = document.getElementById('button-connect').disabled = true;
var button_register = document.getElementById('test').disabled = true;
...
function connectInput() {
    ...
    for (var i = 0; i < tab.length; i++) {
        if (tab[i].value === '') {
            ...
            button_connect = document.getElementById('button-connect').disabled = false;
        }
    }
}
...
function registerMdp() {
    ...
    for (var i = 0; i < tab.length; i++) {
        ...
        if (tab[i].value === '' || tab[0].value != tab[1].value ) {
            ...
            tab[i].className = 	'form-control is-valid';
            button_register = document.getElementById('test').disabled = false;
        }
    }
}
